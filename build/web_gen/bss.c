...
extern unsigned char g_entities_ptr[1] __attribute__((alias("g_entities")));
extern unsigned char level_ptr[1] __attribute__((alias("level")));
extern unsigned char playerCorpseInfo_ptr[1] __attribute__((alias("g_scr_data")));
extern unsigned char r_frontEndData_ptr[1] __attribute__((alias("rg")));
extern unsigned char r_limits_ptr[1] __attribute__((alias("vidConfig")));
extern unsigned char r_sys_ptr[1] __attribute__((alias("ri")));
extern unsigned char scrAnimPub_ptr[1] __attribute__((alias("scrAnimPub")));
extern unsigned char scrCompPub_ptr[1] __attribute__((alias("scrCompilePub")));
extern unsigned char scrMemTreeGlob_arr2[1] __attribute__((alias("scrMemTreeGlob")));
extern unsigned char scrParserPub_ptr[1] __attribute__((alias("scrParserPub")));
extern unsigned char scr_const_ptr[1] __attribute__((alias("scr_const")));
extern unsigned char sv_ptr[1] __attribute__((alias("sv")));
extern unsigned char svs_ptr[1] __attribute__((alias("svs")));
